...
export const home = {
  ...
  steps: [
    {
      title: "A captain signs the team up",
  ...
  steps: [
    {
      ...
      body: "One person speaks for the side. They give a team name, the company, and a contact email.",
    },
    {
      title: "List the players",
      body: "Add the players you expect to play. There is no fixed squad size while the format is being confirmed.",
    },
    {
      title: "Accept the waiver",
      body: "The captain reads the waiver and accepts it for the listed team before the form can be submitted.",
    },
    {
      title: "Get your place",
      body: "You are told straight away whether the team is in the league or on the waitlist.",
    },
  ],
  notes: {
    title: "Before you ask",
    body: "Nothing is charged on this site yet, so registering costs you nothing today. Organizers confirm the venue, the match format, and the fees directly with captains.",
  },
};
